...
Input: `/Users/nathanfikes/Projects/GitHub/AutoNav-Charge_Indicator-KiCad_Pcb/Wireless E-Stop/Wireless E-Stop.kicad_pro`
...
- `Wireless E-Stop_design.json`: KiCad-native design JSON from `kicad-monkey`.
...
- `schematics/01_Wireless_E-Stop.svg`: sheet 1/1 `/` instance `/f735cb90-c129-4e62-b97c-0850bd889294`
