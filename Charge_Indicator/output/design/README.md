...
Input: `/Users/nathanfikes/Projects/GitHub/AutoNav-Charge_Indicator-KiCad_Pcb/Charge_Indicator/Charge_Indicator.kicad_pro`
...
- `Charge_Indicator_design.json`: KiCad-native design JSON from `kicad-monkey`.
...
- `schematics/01_Charge_Indicator.svg`: sheet 1/1 `/` instance `/ce5a45ab-8fc2-45f1-907f-8e7f414ac528`
...
- `pcb/copper_layers/Charge_Indicator__F.Cu__review.svg`: copper layer `F.Cu` plus `Edge.Cuts` and 114 enriched drill/slot records
- `pcb/copper_layers/Charge_Indicator__B.Cu__review.svg`: copper layer `B.Cu` plus `Edge.Cuts` and 114 enriched drill/slot records
